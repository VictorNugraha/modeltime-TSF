...
Opsi lain untuk melihat evaluasi model adalah dengan menggunakan fungsi `plot_modeltime_resamples()`. Fungsi tersebut nantinya akan menghasilkan 6 plot interaktif, dimana setiap plot tersebut akan mewakili sebuah perhitungan error untuk setiap pembagian data validasinya, jadinya kita dapat langsung melihat secara menyeluruh bagaimana performa model yang dibuat pada 4 data yang berbeda. 
