...
Dengan menggunakan framework `modeltime`, kita diberikan kebebasan untuk menggunakan berbagai macam model <i>time series forecasting</i> yang dapat disesuaikan dengan kebutuhan. Selain itu framework `modeltime` akan terus melakukan pengembangan <i>ecosystem</i> jadinya akan selalu ada model baru yang dapat kita manfaatkan kedepannya. 
...
- `exp_smoothing()`: Fungsi ini digunakan untuk membuat model Exponential Smoothing dari framework `modeltime`.
...
- `prophet_reg()`: Fungsi ini digunakan untuk membuat model prhophet dari framework `modeltime`.
