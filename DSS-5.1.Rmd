...
Seperti yang sempat disampaikan sebelumnya, fungsi `modeltime_fit_resamples()` juga akan melakukan perhitungan error yang dapat kita manfaatkan untuk evaluasi ketiga model yang sudah kita buat. Agar kita dapat melihat hasil perhitungan error untuk setiap kurun waktu dari ketiga model, kita akan memanfaatkan sebuah fungsi yang bernama `plot_modeltime_resamples()`. Fungsi tersebut nantinya akan menghasilkan sebuah plot interaktif yang 
...
refit_tbl %>%
    modeltime_forecast(h = "1 years", actual_data = crude_oil_clean) %>%
